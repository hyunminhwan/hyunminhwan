...
끈기는 제가 도전에서 성공을 이뤄내는 가장 중요한 요소입니다. 6개월간의 자바와 AWS 풀스택 취업캠프 과정 동안 하루도 빠짐없이 출석하며, 매일 밤늦게까지 복습과 실습을 반복하며 출석률 100%를 기록했습니다. 특히 ‘붕대감기’와 같은 어려운 코딩 문제를 끝까지 해결하며 성취감을 느꼈던 경험은 제 끈기의 가치를 증명한 사례입니다.

두 번째는 학습에 대한 열정입니다. 새로운 기술을 배우고 성장하는 과정에서 느끼는 즐거움은 저를 개발자로 한 단계 더 성장시키는 원동력이 됩니다. Node.js, Spring Boot와 같은 기술을 처음 접했을 때도 공식 문서와 다양한 자료를 통해 스스로 학습하며 익혔고, 이를 실무 프로젝트에 적용했습니다. 새로운 기술과 도구를 배우는 데 두려움이 없으며, 이를 적극적으로 활용해 문제를 해결하고 가치를 창출합니다.
...
이렇듯 끈기, 학습에 대한 열정, 팀워크를 바탕으로 새로운 기술과 도전에 대한 불안을 흥분과 기대감으로 전환하며 도전을 즐길 수 있었습니다.
